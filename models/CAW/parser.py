...
def get_args():
    ...
    parser.add_argument('-d', '--data', type=str, help='data sources to use, try wikipedia or reddit',
                        choices=['wikipedia', 'reddit', 'socialevolve', 'uci', 'enron', 'socialevolve_1month', 'socialevolve_2weeks', 'ethereum', 'aminer', 'yelp'],
                        default='wikipedia')
    ...
    parser.add_argument('--val_split_time', type=float, default=0.70, help='time point at which val portion of dataset starts')
    parser.add_argument('--test_split_time', type=float, default=0.85, help='time point at which test portion of dataset starts')
